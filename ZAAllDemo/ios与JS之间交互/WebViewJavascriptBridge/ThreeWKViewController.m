...
@interface ThreeWKViewController ()<WKNavigationDelegate,WKUIDelegate>
...
@implementation ThreeWKViewController
...
- (void)initWKWebView
{
    ...
    NSString *urlStr = [[NSBundle mainBundle] pathForResource:@"three.html" ofType:nil];
